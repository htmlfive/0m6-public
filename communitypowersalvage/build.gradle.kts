...
group = "org.powbot.community.communitypowersalvage"
version = "1.0.1"
...
tasks.jar {
    archiveBaseName.set("CommunityPowerSalvage")
}

application {
    mainClass.set("org.powbot.community.communitypowersalvage.CommunityPowerSalvageKt")
}
